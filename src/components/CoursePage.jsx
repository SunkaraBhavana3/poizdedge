...
const courseData = {
    title: "Clinical Excellence Training: GCP & Protocol Mastery",
    rating: 4.8,
    enrollments: "1,250",
    price: "$499.00",
    ...
    // NOTE: Replace this with your actual repo link
...
const modulesData = [
    ...
    {
        id: 2,
        title: "Module 2: Good Clinical Practice (GCP) Guidelines",
        lessons: [
    ...
    {
        id: 3,
        title: "Module 3: Study Design and Protocol Development",
        lessons: [
                            ...
                            <div
                                ...
                                style={{
                                    maxHeight: isModuleActive(module.id) 
                                        ? `${contentRefs.current[module.id]?.scrollHeight}px` 
                                        : '0px',
                                }}
                            >
