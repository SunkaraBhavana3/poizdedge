...
const modulesData = [
    {
        id: 1,
        title: "Module 1: Introduction to Regulatory Affairs &amp; Global Drug Development",
        lessons: [
    ...
    {
        id: 2,
        title: "Module 2: Regulatory Documentation and Dossier Preparation",
        lessons: [
    ...
    {
        id: 3,
        title: "Module 3: Global Regulatory Pathways and Market Authorization",
        lessons: [
     ...
     {
        id: 4,
        title: "Module 4: Regulatory Compliance, Audits, and Emerging Trends",
        lessons: [
