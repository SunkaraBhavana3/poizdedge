  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between">
        ...
        {/* Adjusted lg:items-center to lg:items-start for better alignment on desktop */}
        <div className="lg:w-1/2 text-center flex flex-col items-center lg:items-start mb-12 lg:mb-0"> 
          ...
          {/* Adjusted text alignment for a standard hero layout on desktop */}
          <p className="text-4xl sm:text-5xl font-extrabold leading-tight mb-8 max-w-xl lg:text-left">
            Join thousands of students achieving their academic goals with our expert-led online courses
          </p>

          {/* Fixed Button Group: Changed justify-center to justify-start for desktop alignment */}
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4"> 
            <button 
              className="px-6 py-3 border-2 border-white text-base font-medium rounded-full" // ⬅️ FIX APPLIED HERE: Added hover:text-indigo-900
              style={{ 
                borderColor: 'white', 
                color: 'white'
              }}
