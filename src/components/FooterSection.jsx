...
const FooterSection = () => {
    ...
    // Helper component with robust underline removal
    const SocialIcon = ({ Icon, label }) => (
        <a
            href="#"
            aria-label={label}
            // Ensure no underline in default or hover state
        ...
        <footer className="pt-16" style={{ backgroundColor: darkBlue, color: 'white' }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-gray-700">
                        ...
                        <ul className="space-y-3">
                            {quickLinks.map((link, index) => (
                                <li key={index}>
                                    <a
                                        href={link.href}
                                        // Ensures no underline in default or hover state
                    ...
                    {/* Column 3: Popular Courses - FIXED */}
                    <div>
                    ...
                    <div>
                        ...
                        {/* Social Media Icons (Fixed via the SocialIcon component) */}
